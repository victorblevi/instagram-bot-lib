...
2. Get [config.js](https://raw.githubusercontent.com/social-manager-tools/instagram-bot-lib/0.9.1/config.js.tpl) file for step 3, fill it properly and remove `.tpl` suffix.
